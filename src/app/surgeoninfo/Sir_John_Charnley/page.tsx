        ...
        <div className="flex flex-col lg:flex-row p-5">
            <div className="w-full lg:w-1/4 lg:pr-5 mb-5 lg:mb-0">
                ...
                <div className='border p-4 rounded shadow mt-4'>
                    ...
                    <ul className="list-disc list-inside mt-2">
                        <li>Date of Birth: 29 August 1911</li>
                        <li>Date of Death: 5 August 1982</li>
                        <li>Serving Period: 1940 - 1982</li>
                    </ul>
                </div>
                <div className='border p-4 rounded shadow mt-4'>
                    <h2 className="text-xl font-semibold ">Places</h2><hr/>
                    <ul className="list-disc list-inside mt-2">
                        <li>Birth Place: Bury, Lancashire, England</li>
                ...
                <div className='border p-4 rounded shadow mt-4'>
                    ...
                    <ul className="list-disc list-inside mt-2">
                        <li>Pioneered hip replacement surgery</li>
                        <li>Developed the low-friction arthroplasty</li>
                        <li>Established the Centre for Hip Surgery at Wrightington Hospital</li>
                    </ul>
                </div>
                <div className='border p-4 rounded shadow mt-4'>
                    <h2 className="text-xl font-semibold mt-2">Resources</h2><hr/>
                    <ul className="list-disc list-inside mt-2">
                        <li><a href="https://en.wikipedia.org/wiki/John_Charnley" target="_blank" rel="noopener noreferrer" className="text-blue-500">Wikipedia</a></li>
                        <li><a href="https://www.britannica.com/biography/John-Charnley" target="_blank" rel="noopener noreferrer" className="text-blue-500">Britannica</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div className="w-full lg:w-2/3 lg:mr-4 text-justify mb-5 lg:mb-0">
                ...
                <p className="mt-4">
                    ...
                    was evident then to his mentors and contemporaries that he was destined for a brilliant career.
                </p>
                <p className="mt-4">
                    ...
                    laboratory.
                    After the war, Charnley returned to Manchester; he was appointed lecturer in orthopedic
                ...
                <p className="mt-4">
                    In 1947 he was appointed Consultant Orthopedic Surgeon to Manchester Royal Infirmary and
                    in 1950 his book on the Closed Treatment of
                    Common Fractures was published. It was an original and stimulating approach to the manipulative
                    treatment of fractures “which far from being a
                    crude and uncertain art can be resolved into something of a science.” It was an instant success and
                    ...
                    available. His technique of compression arthrodesis of the knee, published in 1948, was simple and
                    highly effective. The principle of this operation
                    was extended to the hip and other joints. Compression arthrodesis of the hip was an ingenious
                    ...
                    anathema to him; it offended his engineering principles and required a prolonged period of rehabilitation. Total joint replacement was the only
                    solution.
                </p>
                <p className="mt-4">
                    Charnley was appointed Professor of Orthopedic Surgery at Manchester Royal Infirmary in
                    1972. He was appointed as a Doctor of Science
                    of Manchester University in 1964 for his work on
                    bone union and lubrication of joints. His remarkable achievements in the development of total
                    joint replacement had received worldwide
                    acclaim and the award of many honors and decorations. He was made a Commander of the
                    ...
                    some 15 years totally concentrated on this difficult problem by a combination of engineering,
                    biological science, and superb surgical technique
                    he has resolved these problems to the immense
                    benefit of tens of thousands of patients. His investigation of the mechanical, material, and surgical
                    problems of total replacement of the hip have
                    helped to advance joint replacement in the knee,
                    elbow and elsewhere.” He received honorary doctorates of the Universities of Liverpool, Leeds,
                    ...
                    perform the operation must first master the technique by working with him at Wrightington.
                </p>
                <p className="mt-4">
                    ...
                    was determined that surgeons should not undertake the operation with only general knowledge
                    of the principle in the hope that they could
                    improvize the details. A constant stream of surgeons came to Wrightington from all over the
                    ...
                    surgery.
                    He had no time for medical politics or committees and it was the “establishment” more than
                    anything else that provoked his occasional explosions of anger. He worked with unabated energy
                    ...
                    about in boats and in his younger days he was a
                    ...
                    August 5, 1982. He will be remembered by posterity for his low-friction arthroplasty of the
                ...
                <p className="mt-4">
                    ...
                    Regional Hospital Board. What he never discussed is the superhuman effort and singlemindedness needed to achieve the aim he so
                    firmly believed in.
                    Starting with a single clinical observation of a
                    squeaking femoral head replacement, he repeated
                    experiments on lubrication of joints and disproved the results of others.
                    ...
                    It was at this stage that the concept of “low frictional torque arthroplasty” was conceived and
                    ...
                    results had been so spectacular that he was convinced of the soundness of this concept. From
                ...
                <p className="mt-4">
                    ...
                    very busy clinical practice and teaching both residents and visiting surgeons. He traveled extensively, lecturing, demonstrating and operating. He
                    invariably provided the photographs and drawings for his numerous publications, including Low
                    ...
                    his past residents.
                    Every new problem was a challenge to be mastered. When histology of the bone-cement junction was to be studied, he took up the challenge
...
export default SirJohnCharnleyPage;