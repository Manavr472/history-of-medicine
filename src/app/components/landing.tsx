        ...
        <>
            <div ref={ref} className="container flex flex-col md:flex-row items-center justify-between text-center px-4 sm:px-8 md:px-12 lg:px-20 py-8 mt-10 md:mt-16 lg:mt-20 mx-auto">
                ...
                >
                    ...
                    <p className="text-lg mb-6">Explore our detailed timeline to understand the evolution of medical implants and their impact on healthcare. Our timeline feature provides a chronological view of significant milestones and advancements in the field.</p>
