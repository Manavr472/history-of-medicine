...
const HistoryPage: React.FC = () => {
    return (
        <><div className="p-4 sm:p-8 bg-gray-900 rounded-lg">
            ...
            <table className="min-w-full border border-gray-200 bg-gray-900">
            <thead>
                <tr className='bg-gray-500'>
                <th className="py-2 px-4 border">Image</th>
                <th className="py-2 px-4 border">Name</th>
                <th className="py-2 px-4 border hidden sm:table-cell">Contribution</th>
                </tr>
            </thead>
            <tbody>
                {doctors.map((doctor, index) => (
                <tr key={index} className="hover:bg-gray-700 text-center border">
                    ...
                    <td className="py-2 px-4 text-center align-middle border">
                    <div>{doctor.name}</div>
                    <div>{doctor.year}</div>
                    ...
                    <td className="py-2 px-4 text-center align-middle border hidden sm:table-cell">{doctor.contribution}</td>
                </tr>
                ))}
            </tbody>
            </table>
